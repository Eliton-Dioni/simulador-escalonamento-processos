...
import { processos } from '../RegisterPrioridade/index';
import './styles.css';
  ...
  return (
    <div className="prioridade-container">
      <header>
        ...
        <h2>Algoritmo Prioridade FIFO</h2>
        <Link className="button" to="/registerprioridade/new">Adicionar Processo</Link>
      ...
      <footer>
        <Link type="button" className="button" onClick={handleNew} to="/prioridade">Nova Consulta</Link>
